...
import com.example.user.bulletfalls.Storage.Data.LevelRepository;
...
public class UserProfile {
    ...
    {
        boolean  flag;
        List<MutablePair<Currency,Integer>> stockClone=new ArchivContainer<>(stock).cloneList();
...
////////////////////////////GETTERS & SETTERS
    ...
    public boolean buy(PossesAble possesAble)
    {
        if(possesAble.getPossesStrategy().tryToPosses(this))
        {

            UserCollection.getInstance().succesfulTransaction(possesAble);
            return true;
        }
        return false;
    }
