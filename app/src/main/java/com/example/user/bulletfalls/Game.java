    ...
    public void addView(final ViewElement viewElement) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                viewElement.getLayoutParams().height=viewElement.height;
                viewElement.getLayoutParams().width=viewElement.width;
    ...
    public void addViewCharacter(final Character viewCharacter) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                viewCharacter.getLayoutParams().height=viewCharacter.height;
                viewCharacter.getLayoutParams().width=viewCharacter.width;
    ...
    public void uploadLifeView(final Character character, final TextView textLife)
    {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                // Stuff that updates the UI
                textLife.setText(character.life+"");
              ...
              //  float y=character.getY();
                ...
                textLife.setX(character.getX()+character.getWidth()/2-textLife.getMeasuredWidth()/2);
