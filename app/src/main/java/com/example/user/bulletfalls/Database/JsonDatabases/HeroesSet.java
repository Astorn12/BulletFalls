...
public class HeroesSet {
    ...
    public static void AddToDatabaseTest(Context context1)
    {
       // Ability ability= new Ability("ability",R.drawable.heal,10000,new Heal(50),Permission.YES);
        ...
        Hero hero1= new Hero(context,10,20,null,p,p,20,R.drawable.eater,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,20,1,0,null,"Eater",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"żaden",Permission.YES,new Description(),ps,1);
        Hero hero2= new Hero(context,10,20,null,p,p,20,R.drawable.rinor,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,20,1,0,null,"Rinor",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"żaden",Permission.YES,new Description(),ps,1);
        Hero hero3= new Hero(context,10,20,null,p,p,20,R.drawable.pansyk,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,20,1,0,null,"Pansyk",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"żaden",Permission.YES,new Description(),ps,1);

        Hero mabel= new Hero(context,10,30,null,p,p,20,R.drawable.mabel,null/*(FrameLayout) this.findViewById(R.id.frame)*/,0,20,1,0,null,"Mabel Pines",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"żaden",Permission.YES,new Description(),ps,1);
        ...
        Hero dipper= new Hero(context,10,20,null,p,p,20,R.drawable.dipper,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,70,1,0,null,"Dipper Pines",null,Arrays.asList(GroupName.MysteryShack),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"dipper",Permission.YES,new Description(),ps,1);
        AbilitySet as=AbilitySet.getInstance();
        BarAbilities dipperBarAbilities=new BarAbilities(as.getAbility("firstjurnal"),as.getAbility("secondjurnal"),as.getAbility("thirdjurnal"));
        dipper.setAbilities(dipperBarAbilities);

        Hero soos= new Hero(context,10,20,null,p,p,20,R.drawable.soos,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,50,1,0,null,"Soos Ramirez",null,Arrays.asList(GroupName.MysteryShack),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"soos",Permission.NOT,new Description(),ps,2);
        Hero stanek= new Hero(context,5,20,null,p,p,20,R.drawable.stanek,null/*(FrameLayout) this.findViewById(R.id.frame)*/,100,20,1,0,null,"Stan Pines",null,Arrays.asList(GroupName.MysteryShack),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"stanek",Permission.NOT,new Description(),ps,3);
        ...
        Hero grenda= new Hero(context,4,10,null,p,p,20,R.drawable.grenda,null/*(FrameLayout) this.findViewById(R.id.frame)*/,200,50,1,5,null,"Grenda",null,Arrays.asList(GroupName.MabelTeam),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"grenda",Permission.YES,new Description(),ps,1);
        Hero loglandgirl= new Hero(context,4,10,null,p,p,20,R.drawable.loglandgirl,null/*(FrameLayout) this.findViewById(R.id.frame)*/,200,50,1,5,null,"Log Land Girl",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"loglandgirl",Permission.YES,new Description(),ps,1);
        ...
        Hero candy= new Hero(context,4,10,null,40,p,20,R.drawable.candy,null/*(FrameLayout) this.findViewById(R.id.frame)*/,200,50,1,5,null,"Candy Chiu",null,Arrays.asList(GroupName.MabelTeam),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"candy",Permission.YES,new Description(),ps,1);
        Hero mcgucket= new Hero(context,4,10,null,40,p,20,R.drawable.mcgucket,null/*(FrameLayout) this.findViewById(R.id.frame)*/,200,50,1,5,null,"Old Man McGucket",null,Arrays.asList(GroupName.Null),CharacterPositioning.LEFTCENTER,new Standard(),abilitirs,"mcgucket",Permission.YES,new Description(),ps,1);
